            ...
            <div>
                <div className='sm:flex bg-[#FFECD0] text-18px rounded flex-col items-center py-10 px-10'>
                    ...
                    <div className="relative top-4 flex flex-col">
                        <svg
                            className='absolute inset-y-0 left-[3.8rem] top-3 pl-1 flex items-center text-[#BABABA]'
                        ...
                        <input
                            ...
                            className='sm:w-[410px] w-[300px] m-auto h-[42px] bg-[#fff] text-[1rem] pl-9 pr-3 py-1 mb-5 border-none focus:outline-none focus:border-transparent focus:ring-0'
                        />
                    </div>
                </div>
