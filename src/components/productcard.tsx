    ...
    return (
        <div className='px-2 py-4'>
            ...
            {showModal && (
                ...
                <div
                    onClick={ToggleModal}
                    className='fixed opacity-[0.92] flex items-center w-full z-[2000] h-[100vh] bg-[#d8cece] top-[70px] bottom-[60px] left-0 right-0'>

                    <div className='flex justify-between items-center py-[2.5rem] px-[3rem] z-[1500] fixed top-[20%] left-[20%]
                        bottom-[10%] w-[60%] bg-[#fff] shadow-lg' >
